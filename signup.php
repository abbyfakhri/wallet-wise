        ...
        <div>
            ...
            <div class = "box">
                ...
                <div id="username" class="forms container">
                    ...
                    <div>
                            <div >
                              <input type="text" name="username" id="username" placeholder ="email or username" style= "text-align: center;" class = "textbox" value="<?php echo $username; ?>"required>
                        </div>
                ...
                <div id="confirm-password" class="forms container">
                    ...
                    <div>
                            <div >
                              ...
                              <input type="password" name="cpassword" id="password" placeholder ="confirm password" style= "text-align: center;" class = "textbox" value="<?php echo $_POST['cpassword']; ?>" required>
