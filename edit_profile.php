...
<div class="header">
    ...
    <form action="" method="post">
        <div class="container">
    <div id="user" class="forms container">
                    ...
                    <div>
                            <div>
                              ...
                              <input type="text" name="username" id="username" placeholder ="email or username" style= "text-align: center;"class = "textbox" value="<?php echo $_SESSION['username']; ?>"required>
                        </div>
